    ...
    <main className="min-h-screen bg-white pt-14 md:pt-[4.5rem] lg:pt-[4.75rem]">
      ...
      <section className="relative bg-ocean/10 py-12 lg:py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            <h1 className={`text-5xl md:text-6xl lg:text-7xl font-normal text-volcanic mb-4 ${mrDeHaviland.className}`}>
              Apparel
            </h1>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex justify-between items-end mb-8">
          <div>
            <h2 className={`text-2xl md:text-3xl font-bold text-volcanic mb-2 ${mrDeHaviland.className}`}>
              Featured Products
            </h2>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="rounded-xl overflow-hidden shadow-lg relative">
          ...
          <div className="grid grid-cols-1 relative z-10">
            <div className="px-8 py-20 md:py-32 flex flex-col justify-center items-center text-center">
              <div className="max-w-2xl mx-auto">
                <h2 className={`text-4xl md:text-5xl lg:text-6xl font-normal text-white mb-6 drop-shadow-lg ${mrDeHaviland.className}`}>
      ...
      <Link href={link} className="block relative group">
        <div className="relative h-52 overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 p-6">
            <h3 className={`text-3xl md:text-4xl font-normal text-white mb-2 ${mrDeHaviland.className}`}>{title}</h3>
