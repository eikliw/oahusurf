...
export default function BlogPostPage() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-white pt-14 md:pt-[4.5rem] lg:pt-[4.75rem] flex justify-center items-center">
  ...
  if (error || !post) {
    return (
      <div className="min-h-screen bg-white pt-14 md:pt-[4.5rem] lg:pt-[4.75rem] flex flex-col justify-center items-center">
        <h1 className="text-2xl text-volcanic mb-4">{error || "Post not found"}</h1>
